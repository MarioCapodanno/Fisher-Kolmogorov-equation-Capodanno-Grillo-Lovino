...
void ParameterReader::declare_parameters() {
  ...
  {
    prm.declare_entry("Dext", "1.0", Patterns::Double(0),
                      "Dext coefficient for diffusion term");
    prm.declare_entry("Daxn", "10.0", Patterns::Double(0),
                      "Daxn coefficient for diffusion term");
    prm.declare_entry("Alpha coefficient", "0.1", Patterns::Double(0),
  ...
  {
    prm.declare_entry("T", "1.0", Patterns::Double(0), "Final simulation time");

    prm.declare_entry("deltat", "0.1", Patterns::Double(0), "Time step size");
